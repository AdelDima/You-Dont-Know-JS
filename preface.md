...
Welcome to the 2nd edition of the widely acclaimed _You Don't Know JS_ \(**YDKJS**\) book series: _You Don't Know JS **Yet**_ \(**YDKJSY**\).

If you've read any of the 1st edition books, you can expect a refreshed approach in these new ones, with plenty of updated coverage of what's changed in JS over the last five years. But what I hope and believe you'll still _get_ is the same commitment to respecting JS and digging into what really makes it tick.
